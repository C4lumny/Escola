...
export const ViewTeachers = () => {
  ...
  if (!loading) {
    ...
    filteredData = dataTable.filter((parent: any) => parent.cedula.toString().includes(filter));
  }
  ...
  return (
    <div>
      {loading ? (
        ...
        <div>
          <div>
            <h1 className="text-xl font-semibold tracking-tight">Visualizar acudientes</h1>
            <p className="text-muted-foreground">Aqui puedes ver los acudientes activos.</p>
          </div>
